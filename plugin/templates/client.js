...
(function () {
  ...
  var obj = {
    ...
    /**
     * Ask embedding KorAP for the query/koralquery 
     * for example  getQuery(0) -> query
     * getQuery(1) -> koralQuery
     * TODO HK think about it, or with msg-> query, koralquery?
     * TODO HK wie richtig benennen...
     */
     kquery : function (code) {
      this.sendMsg({
        action : 'getQuery',
        code : code,
      //  msg : msg
